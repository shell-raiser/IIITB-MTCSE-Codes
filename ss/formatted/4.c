 ...
 *
 * Opened testfile.txt in O_RDWR mode, fd = 3
 * Content: Initial content
 * Appended to file and closed.
 *
 * --- O_EXCL Experiment ---
 * open with O_CREAT|O_EXCL on existing file failed (expected): File exists
 * Created newfile.txt with O_CREAT|O_EXCL, fd = 3
 * Opened with O_EXCL only (no O_CREAT), fd = 3
 */
