 ...
 * ./64.c:18:21: error: implicit declaration of function ‘strcmp’ [-Wimplicit-function-declaration]
 *    18 |     if (argc > 1 && strcmp(argv[1], "sender") == 0) {
 *       |                     ^~~~~~
 * ./64.c:10:1: note: include ‘<string.h>’ or provide a declaration of ‘strcmp’
 *     9 | #include <unistd.h>
 *   +++ |+#include <string.h>
 *    10 |
 */
