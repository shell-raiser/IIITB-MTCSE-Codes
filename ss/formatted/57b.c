 ...
 * ./57b.c:95:41: error: ‘_SC_PATH_MAX’ undeclared (first use in this function); did you mean ‘_PC_PATH_MAX’?
 *    95 |     printf("  PATH_MAX: %ld\n", sysconf(_SC_PATH_MAX));
 *       |                                         ^~~~~~~~~~~~
 *       |                                         _PC_PATH_MAX
 * ./57b.c:95:41: note: each undeclared identifier is reported only once for each function it appears in
 * ./57b.c:96:41: error: ‘_SC_PIPE_BUF’ undeclared (first use in this function); did you mean ‘_PC_PIPE_BUF’?
 *    96 |     printf("  PIPE_BUF: %ld\n", sysconf(_SC_PIPE_BUF));
 *       |                                         ^~~~~~~~~~~~
 *       |                                         _PC_PIPE_BUF
 */
